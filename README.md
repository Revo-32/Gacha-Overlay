...
2.4.2는 주간 보너스·할인을 같은 배율과 할인율별로 묶어 반복 제목을 줄인 클라이언트 UI 패치입니다. GTA$·RP와 속도 보너스, 일반 할인과 GTA+ 회원 전용 할인은 구분합니다. **새 ZIP으로 앱을 업데이트해야 적용됩니다.**

LS Overlay는 Rockstar Games, Take-Two Interactive, Discord, Google과 제휴하거나 이들의 승인을 받은 제품이 아닌 독립적인 비공식 도구입니다.

## 2.4 주요 기능

- **공개 GTA 이벤트 AI 번역**: 승인 용어집과 사실값 검증으로 자연스러운 한국어를 제공합니다. 검증된 번역을 서버에 저장·재사용하며 실패 시 안전한 기존 정보나 원문을 표시합니다.
...
[GitHub Releases](https://github.com/Revo-32/Gacha-Overlay/releases)에서 **LS-Overlay-2.4.2-win-x64.zip**을 받으세요. GitHub가 자동 생성하는 **Source code** 파일은 실행용 패키지가 아닙니다.
...
- [LS Overlay 2.4.2 릴리즈 노트](docs/releases/LS-Overlay-2.4.2-release-notes.md)
...
두 PDF는 조작이 동일한 승인된 2.4 계열 문서를 그대로 재사용합니다. 문서 속 2.4.0 다운로드·체크섬 예시 대신 이번 릴리즈의 2.4.2 파일명을 사용하세요.
