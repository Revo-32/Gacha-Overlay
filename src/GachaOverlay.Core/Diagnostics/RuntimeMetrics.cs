...
public static class RuntimeMetricNames
{
    ...
    public const string MediaAnimationActivePlayers = "media.animation.active_players";
    public const string MediaAnimationFrameDecoded = "media.animation.frame_decoded.count";
    public const string MediaAnimationFramesPresented = "media.animation.frame_presented.count";
    public const string MediaAnimationFrameFailed = "media.animation.frame_failed.count";
    public const string MediaAnimationDecodeDuration = "media.animation.decode.duration";
    public const string MediaAnimationFramesSkipped = "media.animation.frame_skipped.count";
    public const string MediaAnimationDecoderCount = "media.animation.decoder.count";
    public const string MediaAnimationFrameBuffers = "media.animation.frame_buffers.count";
    public const string MediaAnimationDisposals = "media.animation.disposal.count";
    public const string MediaAnimationSchedulerActive = "media.animation.scheduler_active";
    public const string MediaAnimationEnabled = "media.animation.enabled";
    public const string BusinessActiveTimers = "business.timer.active.count";
    public const string BusinessWallClockTimers = "business.timer.wall_clock.count";
    public const string BusinessOnlineTimers = "business.timer.online_playtime.count";
    public const string BusinessPausedTimers = "business.timer.paused.count";
    public const string BusinessPausedUnknownPresence = "business.timer.paused_unknown_presence.count";
    public const string BusinessReadyTimers = "business.timer.ready.count";
    public const string BusinessMansionBoostActive = "business.mansion_boost.active";
    public const string BusinessOnlineState = "business.online_playtime.state";
