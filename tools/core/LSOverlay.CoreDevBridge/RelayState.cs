...
internal sealed class RelayState
{
    ...
    private readonly CoreSemanticProjection _projection = new(new MetadataOnly());
    private readonly CoreSalesPresentationProjection _presenter = new(CoreSalesPresentationProjection.Strings(new ResourceLocalizationService("ko")));
    ...
    public RelayState(BootstrapResponse identity)
    {
        ...
        _engine = new(names,EmbeddedSalesProductCatalogLoader.Load(),locale:"ko");
    ...
    public CoreSnapshot Capture()
    {
        ...
        return _presenter.Apply(snapshot,canonical,health) with { ChatConnectionState = ChatStatus };
    }
