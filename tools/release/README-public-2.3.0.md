...
2.3.0은 알림센터, 멘션 강조 선택, 판매 상세 이모지, 한국어 용어와 GTA 실행 감지를 개선한 릴리즈입니다. F10으로 잠금을 푼 뒤 설정 왼쪽 종 버튼에서 알림을 확인합니다. 알림 글자는 12pt이며 배경은 항상 불투명합니다.
...
- [빠른 시작 가이드](LS-Overlay-2.3-Quick-Start-ko.pdf): 압축 해제, 인증, F9/F10, 첫 사용
- [상세 사용자 설명서](LS-Overlay-2.3-User-Guide-ko.pdf): 채팅, 판매, 컴패니언, 사업장 관리자, 단축키와 문제 해결
