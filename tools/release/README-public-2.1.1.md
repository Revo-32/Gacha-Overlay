...
2.1.1은 재연결 후 채팅 복구, 판매 동기화와 움직이는 미디어의 성능 및 리소스 정리를 개선한 핫픽스입니다.
...
- [빠른 시작 가이드](LS-Overlay-2.1-Quick-Start-ko.pdf): 압축 해제, 인증, F9/F10, 첫 사용
- [상세 사용자 설명서](LS-Overlay-2.1-User-Guide-ko.pdf): 채팅, 판매, 컴패니언, 사업장 관리자, 단축키와 문제 해결
