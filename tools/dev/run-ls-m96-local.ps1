<#
.SYNOPSIS
Starts the isolated M9.6 Remote Sales cutover validation session.

.EXAMPLE
powershell.exe -NoProfile -ExecutionPolicy Bypass -File ".\tools\dev\run-ls-m96-local.ps1"
#>
[CmdletBinding()]
param(
    [string]$GuildId,
