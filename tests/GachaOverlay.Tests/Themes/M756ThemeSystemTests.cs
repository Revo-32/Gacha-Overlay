...
public sealed class M756ThemeSystemTests
{
    ...
    public void Catalog_CorePaletteMatchesApprovedSpecification()
    {
        AssertPalette(
            ...
            "#0D1117|#161B22|#21262D|#30363D|#F0F6FC|#C9D1D9|#8B949E|#58A6FF|#A371F7|#3FB950|#58A6FF|#3FB950|#58A6FF|#D29922|#F85149|#FF000000");
        AssertPalette(
            ColorThemeId.OneDarkPro,
            "#1E222A|#282C34|#303540|#3E4451|#E8EBF0|#C8CDD5|#8D949F|#61AFEF|#C678DD|#98C379|#56B6C2|#98C379|#61AFEF|#E5C07B|#E06C75|#FF000000");
        AssertPalette(
            ColorThemeId.Nord,
            "#2E3440|#3B4252|#434C5E|#4C566A|#ECEFF4|#D8DEE9|#A7B0C0|#88C0D0|#B48EAD|#A3BE8C|#81A1C1|#A3BE8C|#88C0D0|#EBCB8B|#BF616A|#FF000000");
        AssertPalette(
            ColorThemeId.TokyoNight,
            "#1A1B26|#24283B|#2B3046|#3B4261|#D5DAFF|#A9B1D6|#8C94B8|#7AA2F7|#BB9AF7|#9ECE6A|#7DCFFF|#9ECE6A|#7DCFFF|#E0AF68|#F7768E|#FF000000");
        AssertPalette(
            ColorThemeId.Monokai,
            "#1D1E1A|#272822|#303129|#49483E|#F8F8F2|#D7D7CC|#A0A097|#66D9EF|#AE81FF|#A6E22E|#66D9EF|#A6E22E|#66D9EF|#E6DB74|#F92672|#FF000000");
    }
